...
var getUserIdFromToken_1 = __importDefault(require("../../controllers/users/getUserIdFromToken"));
var protect = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token;
    return __generator(this, function (_a) {
        token = (0, getUserIdFromToken_1.default)(req).token;
        if (!token) {
            ...
            db_1.default.execute("SELECT invalid_tokens FROM invalid_tokens WHERE invalid_tokens = ?", [token], function (err, result) {
                if (err) {
