...
var updateImg = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user_id;
    return __generator(this, function (_a) {
        ...
        multer_1.upload.single("img")(req, res, function (err) { return __awaiter(void 0, void 0, void 0, function () {
            var uniqueIdentifier, publicId, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (err) {
                    ...
                    case 1:
                        result = _a.sent();
                        try {
                            db_1.default.execute("UPDATE users SET img = ? WHERE user_id = ?", [result.secure_url, user_id], function (error) {
                                if (error) {
                                    console.error(error);
                                    res
                                        .status(500)
...
//# sourceMappingURL=updateImg.js.map