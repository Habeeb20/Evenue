...
exports.forgotPassword2ndStep = void 0;
var db_1 = __importDefault(require("../../db/db"));
var forgotPassword2ndStep = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, code, email;
                ...
                try {
                    connection.query("START TRANSACTION;", function (error) {
                        if (error) {
                            ...
                            connection.query("SELECT code_id, code, request_email FROM forgot_password_codes WHERE code = ? AND request_email = ?;", [code, email], function (error, result) {
                                if (error) {
                                    // Handle query error
                                    console.error(error);
                                    res.status(500).json({ error: "Internal server error" });
                                    ...
                                    connection.query("UPDATE forgot_password_codes SET verified = 'true' WHERE code = ? AND request_email = ?;", [code, email], function (error) {
                                        if (error) {
...
exports.forgotPassword2ndStep = forgotPassword2ndStep;
//# sourceMappingURL=forgotPassword2.js.map