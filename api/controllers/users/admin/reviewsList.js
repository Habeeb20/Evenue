...
exports.reviewsList = void 0;
var db_1 = __importDefault(require("../../../db/db"));
var getUserIdFromToken_1 = __importDefault(require("../getUserIdFromToken"));
// add check for admin
var reviewsList = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user_id;
    return __generator(this, function (_a) {
        ...
        db_1.default.execute("SELECT id, review FROM e_service_reviews;", function (err, result) {
            if (err) {
                console.error(err);
