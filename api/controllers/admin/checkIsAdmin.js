...
var checkIsAdmin = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user_id;
    return __generator(this, function (_a) {
        ...
        try {
            db_1.default.execute("SELECT * FROM users WHERE user_id = ? AND is_admin = '1'", [user_id], function (err, result) {
                if (err) {
                    console.error(err);
