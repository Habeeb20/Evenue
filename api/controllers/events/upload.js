...
var uploadEvent = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user_id;
    return __generator(this, function (_a) {
        ...
        multer_2.upload.array("imgs", 5)(req, res, function (error) { return __awaiter(void 0, void 0, void 0, function () {
            var _a, name, description, location, url, category, frequency, time_zone, start_date_and_time, end_date_and_time, price, pictureUrls, _i, _b, file, uniqueIdentifier, publicId, result;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _a = req.body, name = _a.name, description = _a.description, location = _a.location, url = _a.url, category = _a.category, frequency = _a.frequency, time_zone = _a.time_zone, start_date_and_time = _a.start_date_and_time, end_date_and_time = _a.end_date_and_time, price = _a.price;
                        pictureUrls = Array();
                        _i = 0, _b = req.files;
                        _c.label = 1;
                    case 1:
                            ...
                            if (error) {
                                ...
                                connection.query("START TRANSACTION;", function (error) {
                                    if (error) {
                                        ...
                                        try {
                                            // Insert event data
                                            connection.query("INSERT INTO events (user_id, name, description, location, url, category, frequency, time_zone, start_date_and_time, end_date_and_time, price) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", [
                                                user_id,
                                                name,
                                                description,
                                                location,
                                                ...
                                                connection.query("INSERT INTO events_imgs (event_id, imgs) VALUES ?", [values], function (error) {
                                                    if (error) {
